...
export default function Checkout() {
  ...
  useEffect(() => {
    const fetchCart = async () => {
      try {
        const cartRef = query(cartCollection, where("user", "==", userID));
  ...
  const handlePaystackSuccessAction = async (reference) => {
    ...
    if (userID && reference.status === "success") {
      try {
...
<p class="text-center" style="line-height: 1.25em; text-align: center; margin: 0px; padding: 0px;">Thank you for purchasing a ticket for ${
            cartData.movieTitle
          }! We're excited to have you join us for this movie. Below are the details of your purchase:</p><p class="text-center" style="line-height: 1.25em; text-align: center; margin: 0px; padding: 0px;"><br></p></td></tr></tbody></table></div><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr><tr><td class="drow" valign="top" align="center" style="background-color: #ffffff; box-sizing: border-box; font-size: 0px; text-align: center;"><!--[if (gte mso 9)|(IE)]><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><![endif]--><div class="layer_2" style="max-width: 100%; display: inline-block; vertical-align: top; width: 100%;"><table border="0" cellspacing="0" class="edcontent" style="border-collapse: collapse;width:100%"><tbody><tr><td valign="top" class="edtext" style="padding: 32px; text-align: left; color: #5f5f5f; font-size: 15px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;"><p class="style2 text-center" style="line-height: 1.75em; text-align: center; margin: 0px; padding: 0px; color: #000000; font-size: 26px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><span style="font-size: 20px;">Movie Details</span></p><p style="margin: 0px; padding: 0px;">Movie: ${
            cartData.movieTitle
          }<br>Date & TIme: ${cartData.movieDate}<br>PG: ${
            cartData.pg
          }<br>Duration: ${
            cartData.movieDuration
          }mins</p><p style="margin: 0px; padding: 0px;">Cost:&nbsp;${
            cartData.movieCost
          }<br>Quantity:&nbsp;${cartData.movieQty}<br>Total Amount Paid: ${
            cartData.movieQty * cartData.movieCost
            ...
            reference.trans
          }<br>Payment Date: ${year}-${month}-${day}</p><p style="margin: 0px; padding: 0px;"><br></p><p style="margin: 0px; padding: 0px;"><br></p><p style="margin: 0px; padding: 0px;">If you have any questions or need further assistance, feel free to contact our support team at itunuoluwaadedayo17@gmail.com or by phone at +234-8135793842. We're here to help!</p><p style="margin: 0px; padding: 0px;"><br></p>
<p style="margin: 0px; padding: 0px;">Thank you again for your purchase, and we look forward to seeing you at the cinema!</p><p style="margin: 0px; padding: 0px;"><br></p>
<p style="margin: 0px; padding: 0px;">Best regards,&nbsp;</p><p style="margin: 0px; padding: 0px;">Filmlane</p><p style="margin: 0px; padding: 0px;"><br></p></td></tr></tbody></table></div><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr><tr><td class="drow" valign="top" align="center" style="background-color: #f5f6f8; box-sizing: border-box; font-size: 0px; text-align: center;"><!--[if (gte mso 9)|(IE)]><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td valign="top"><![endif]--><div class="layer_2" style="max-width: 100%; display: inline-block; vertical-align: top; width: 100%;"><table border="0" cellspacing="0" class="edcontent" style="border-collapse: collapse;width:100%"><tbody><tr><td valign="top" class="edtext" style="padding: 20px; text-align: left; color: #5f5f5f; font-size: 15px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;"><p class="text-center" style="line-height: 1.75em; text-align: center; margin: 0px; padding: 0px;"><span style="font-size: 11px;">If you no longer wish to receive mail from us, you can <a href="{unsubscribe}" style="color: #5457ff; text-decoration: none;">unsubscribe</a></span><br><span style="font-size: 11px;">filmlane@gmail.com</span></p></td></tr></tbody></table></div><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr></tbody></table><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--><!--[if (gte mso 9)|(IE)]></td></tr></table><![endif]--></td></tr></tbody></table></body>`,
        };
  ...
  return (
    <>
      <h1 className="pt-3 text-2xl text-center text-white opacity-95">
        Checkout
      </h1>
      <hr className="w-full" />

      {/* Form Input */}
      <div className="inline-block ml-10 space-y-3 text-white">
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="border border-black outline-none w-[300px] text-black"
          />
        </div>
      ...
      <h3 className="my-2 text-3xl text-center text-white">Your Order</h3>
      <hr className="w-full" />

      <div className="px-4 text-white">
        <table className="w-[90%] mx-auto">
          <thead>
            <tr className="flex justify-between border-b-2 border-b-black">
          ...
          <tbody>
            <tr className="flex justify-between border-b-2 border-b-black">
              <td className="py-2 text-lg">
                {cartData.movieTitle ? cartData.movieTitle : ""}
                {cartData.movieQty ? " x" + cartData.movieQty : ""}
              </td>
            ...
            <tr className="flex justify-between border-b-2 border-b-black">
              ...
              <td className="py-2 text-lg font-semibold">
                ₦{" "}
                {cartData.movieCost
                  ? cartData.movieCost * cartData.movieQty
                  : 0}
              </td>
            </tr>
            <tr className="flex justify-between border-b-2 border-b-black">
